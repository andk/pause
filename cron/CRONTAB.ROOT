...
# THE INDEXER
52 * * * *            pause  $PAUSE_REPO/cron/mldistwatch --logfile /var/log/mldistwatch.cron.log
04 7 * * 6            pause  $PAUSE_REPO/cron/mldistwatch --logfile /var/log/mldistwatch.cron.log --symlinkinventory
17,29,41,53 * * * *   pause  $PAUSE_REPO/cron/mldistwatch --logfile /var/log/mldistwatch.cron.log --fail-silently-on-concurrency-protection --rewrite
